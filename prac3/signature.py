...
def verifySender(signature, data, publicKey):
    plainText = publicKey.verify(signature, data, padding.PSS(
...
if __name__ == "__main__":
    ...
    plainText = verifySender(signature, "It's-A Me, Mario!", publicKey)
    print(plainText)
